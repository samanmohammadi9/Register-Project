        ...
        <form method="post" id="product_form">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input name="teacher_name" class="form-control" @if($project->status=='approved') readonly @endif @if($project->status=='approved') readonly @endif @if(isset($project)) value="{{$project->teacher_name}}" @endif placeholder="استاد..."/>
