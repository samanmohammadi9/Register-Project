        ...
        <div class="card card-custom">
            ...
            <div class="card-header align-items-center px-4 py-3">
                ...
                <div class="text-center flex-grow-1">
                    <div class="text-dark-75 font-weight-bold font-size-h5">{{$student->fullName}}</div>
                    <div>
                                ...
                                <div class="d-flex flex-column mb-5 align-items-start">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div style="direction: rtl;text-align: right">
                                            <span class="text-muted font-size-sm"> {{\Carbon\Carbon::now()->diffInMinutes($message['created_at'])}} دقیقه پیش </span>
                                            <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">{{$student->fullName}}</a>
                                        </div>
                                    </div>
