...
<head><base href="">
    ...
    <link href="/assets/css/layout/header/base/light.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <link href="/assets/css/layout/header/menu/light.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <link href="/assets/css/layout/brand/dark.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <link href="/assets/css/layout/aside/dark.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <link href="/assets/css/layout/aside/dark.css?v=7.0.3" rel="stylesheet" type="text/css" />
    <!--end::Layout Themes-->
...
<div class="d-flex flex-column flex-root">
    ...
    @include(auth('teacher')->check()?'teacher.partials.sidebar':'student.partials.sidebar')
    <!--begin::Wrapper-->
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
            @include(auth('teacher')->check()?'teacher.partials.header':'student.partials.header')
            @yield('contents')
        </div>
        <!--end::Wrapper-->
    </div>
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">saman mohammadi</a>
                ...
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary">saman@saman.com</span>
								</span>
                    </a>
...
<script src="/assets/js/widgets.js?v=7.0.3"></script>
@yield('scripts')
<!--end::Page Scripts-->
</body>
<!--end::Body-->
